...
function main() {
  ...
  // eslint-disable-next-line no-undef
  if ((paypal.FUNDING.P24 ?? null) === null) {
    console.error("No P24 attribute with associated paypal.FUNDING object");
    document.getElementById("feedback").innerHTML = "Error loading scripts";
    document.getElementById("error").innerHTML =
      "No P24 attribute with associated paypal.FUNDING object";
    return;
  }
