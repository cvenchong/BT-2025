...
function main() {
  ...
  // eslint-disable-next-line no-undef
  if ((paypal.FUNDING.BLIK ?? null) === null) {
    console.error("No BLIK attribute with associated paypal.FUNDING object");
    document.getElementById("feedback").innerHTML = "Error loading scripts";
    document.getElementById("error").innerHTML =
      "No BLIK attribute with associated paypal.FUNDING object";
    return;
  }
