...
function main() {
  ...
  // eslint-disable-next-line no-undef
  if ((paypal.FUNDING.MYBANK ?? null) === null) {
    console.error("No MYBANK attribute with associated paypal.FUNDING object");
    document.getElementById("feedback").innerHTML = "Error loading scripts";
    document.getElementById("error").innerHTML =
      "No MYBANK attribute with associated paypal.FUNDING object";
    return;
  }
