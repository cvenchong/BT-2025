...
function main() {
  ...
  // eslint-disable-next-line no-undef
  if ((paypal.FUNDING.EPS ?? null) === null) {
    console.error("No EPS attribute with associated paypal.FUNDING object");
    document.getElementById("feedback").innerHTML = "Error loading scripts";
    document.getElementById("error").innerHTML =
      "No EPS attribute with associated paypal.FUNDING object";
    return;
  }
