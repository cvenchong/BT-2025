                      ...
                      onApprove(data) {
                        ...
                        paypalCheckout
                          ...
                          .then(([transactionId, customerId]) => {
                            console.log(
                              `Order with ID ${data.orderID} and transaction with ID ${transactionId} successfully created, settled and vaulted with customer ID ${customerId}`
                            );
                            document.getElementById(
                              "feedback"
                            ).innerHTML = `Order with ID ${data.orderID} and transaction with ID ${transactionId} successfully created, settled and vaulted with customer ID ${customerId}`;
                            document.getElementById("error").innerHTML = "";
